...
if($_POST["accion"] == "buscar horas"){
		...
		/*if($_POST['tramite']==12 and $diaBuzon==1 ){   //// BUZON ELECTRONICO //////
			$horarios = array(
						1 => array("horario" => "10:30", "citas" => 0 , "disponible" => "") ,
						2 => array("horario" => "11:00", "citas" => 0 , "disponible" => "") ,
						3 => array("horario" => "11:30", "citas" => 0 , "disponible" => "") ,
						4 => array("horario" => "12:00", "citas" => 0 , "disponible" => "") ,
						5 => array("horario" => "12:30", "citas" => 0 , "disponible" => "") ,
						6 => array("horario" => "13:00", "citas" => 0 , "disponible" => "") ,
						7 => array("horario" => "13:30", "citas" => 0 , "disponible" => "") ,
						8 => array("horario" => "14:00", "citas" => 0 , "disponible" => "") ,
						9 => array("horario" => "14:30", "citas" => 0 , "disponible" => "")
		...
		if($_POST['tramite']!=4 and $_POST['tramite']!=8 and $_POST['tramite']!=12){   //// OTRO TIPO DE TRAMITE //////
			$horarios = array(
...
if($_POST['accion']=="guardar cita"){
	...
	if( $query = mysqli_query($link, $sql) ){
		...
		echo "surgio un error al registrar la cita  $sql" ;
	}
}
