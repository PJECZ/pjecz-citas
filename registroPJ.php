...
if($capcha == 1){
    ...
    else
    {
      ...
      if($contra!=$contra2 or strlen($contra) < 8 or strlen($contra2) < 8)
      {
        ...
        $sendgrid = new \SendGrid($mail_ini["password"]);
        try {
                                      ...
                                      <div class="row">
                                        <div class="col-md-12">
                                               <div class="form-group">
                                                  ...
                                                  <input id="txtCurp" name="txtCurp" type="text" class="form-control" required="required" onblur="upperCurp(this.value),sexo(this.value); calcularEdad(this.value)" pattern=".{18,18}"  maxlength="18" value="<?php if(isset($curp)) echo $curp?>">
                                                </div>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-md-12">
                                               <div class="form-group">
                                                  ...
                                                  <input id="txtCurp2" name="txtCurp2" type="text" class="form-control" required="required" pattern=".{18,18}" maxlength="18" onblur="upperCurp2(this.value)" value="<?php if(isset($curp2)) echo $curp2?>">
                                                </div>
                                        </div>
                                      </div>
                                      <div class="row">
                                      ...
                                      <div class="row">
                                        <div class="col-md-12">
                                               <div class="form-group">
                                                  ...
                                                  <input id="txtCorreo" name="txtCorreo" type="email" class="form-control" required="required" value="<?php if(isset($correo)) echo $correo?>">
                                                </div>
                                        </div>
                                      </div>
                                      <div class="row">
